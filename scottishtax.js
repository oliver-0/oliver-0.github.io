...
scot_top_Rate = 0.46;
scot_starter_Rate_Cap = 13850;
scot_basic_Rate_Cap = 24000;
...
function scot_taxPayable(income) {
  //initialising these as zeroes each time it runs removes left over values from previous instances of the calculation
  chartTop = 0; //scottish-only
  chartAdditional = 0; //not used
  chartHigher = 0;
